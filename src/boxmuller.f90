! Taken from QCxMS DOI:  10.1021/jasms.1c00098
...
contains
   ...
   ! Do variation of the number of collisions
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   function vary_collisions(calc_collisions, edist) result(box_coll)

      real(wp) :: sigma, res(2)
      real(wp) :: dum, dum2 ! dummys
      real(wp) :: z0, z1
      real(wp), intent(in) :: calc_collisions, edist
      integer  :: box_coll

      call random_number(dum)
      call random_number(dum2)
      sigma = calc_collisions*edist  !dble(0.25)
